...
# import gui_class
import dataset
from utils import load_checkpoint, save_checkpoint, plot_examples, plot_examples_flask, load_checkpoint_flask
...
def train_fn_flask(loader, disc, gen, opt_gen, opt_disc, mse, bce, vgg_loss):
    loop = tqdm(loader, leave=True)
